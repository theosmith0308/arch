...
alias mv='mv -i'
alias rm='rm -i'
alias ls='eza -a --color=auto --group-directories-first --icons=always'    # Ensure "eza" is installed.
alias ll='eza -al --color=auto --group-directories-first --icons=always'  # Ensure "eza" is installed.
